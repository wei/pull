...
module.exports = app => {
  ...
  routes.get('/check/:owner/:repo', (req, res) => {
    ...
    getJSON(`https://api.github.com/repos/${fullName}/contents/.github/${app.CONFIG_FILENAME}?${GITHUB_CREDENTIALS}`)
      ...
      .then((config) => {
        ...
        const reqs = value.rules.map(r => new Promise((resolve, reject) => {
          getJSON(`https://api.github.com/repos/${fullName}/compare/${r.base}...${r.upstream}?${GITHUB_CREDENTIALS}`)
